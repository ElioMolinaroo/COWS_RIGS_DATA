...
facial_path = "//storage/esma/3D4/cows/04_asset/01_character/SILO_cow004/maya/scenes/rig/publish/CHR_SILO_cow004_facial_P.ma"
...
original_facial_geos = (
                        api.Node("SILO_cow004_body_geo", create=False),
                        api.Node("SILO_cow004_mouthPiece_geo", create=False),                  
                        api.Node("SILO_cow004_tongue_geo", create=False),
                        api.Node("SILO_cow004_eyelid_TR_geo", create=False),                          
                        api.Node("SILO_cow004_eyelid_TL_geo", create=False),                         
                        api.Node("SILO_cow004_eyelid_BoL_geo", create=False),                 
                        api.Node("SILO_cow004_eyelid_BoR_geo", create=False),    
                        api.Node("SILO_cow004_eyeSclera_R_geo", create=False),  
                        api.Node("SILO_cow004_eyePupil_R_geo", create=False),
                        api.Node("SILO_cow004_eyeSclera_L_geo", create=False),
                        api.Node("SILO_cow004_eyePupil_L_geo", create=False),
                        api.Node("SILO_cow004_horn_L_geo", create=False),
                        api.Node("SILO_cow004_horn_R_geo", create=False),
)
for geo in original_facial_geos:
    if geo.name == "SILO_cow004_body_geo":
        # This is processed later with the correctives
        continue
    else:
        facial_geo = api.Node(geo.name.replace("_geo", "_facial_geo"), create=False)
    bs = cmds.blendShape(facial_geo.name, geo.name, topologyCheck=False, frontOfChain=True, weight=(0, 1), name=f"SILO_cow004_{facial_geo.name.removesuffix('_geo')}_BS")[0]
...
api.Attribute(api.Node("mouthMaster_M_BS_ctrl", create=False), "tongue_visibility").connect_to(f"SILO_cow004_tongue_geo.visibility")
api.Attribute(api.Node("eye_L_ctrl", create=False), "topEyelid_visibility").connect_to(f"SILO_cow004_eyelid_TL_geo.visibility")
api.Attribute(api.Node("eye_L_ctrl", create=False), "bottomEyelid_visibility").connect_to(f"SILO_cow004_eyelid_BoL_geo.visibility")
api.Attribute(api.Node("eye_R_ctrl", create=False), "topEyelid_visibility").connect_to(f"SILO_cow004_eyelid_TR_geo.visibility")
api.Attribute(api.Node("eye_R_ctrl", create=False), "bottomEyelid_visibility").connect_to(f"SILO_cow004_eyelid_BoR_geo.visibility")
...
cmds.container("SILO_cow004_RIG", edit=True, addNode=facial_nodes)
...
graze_bs = cmds.blendShape("SILO_cow004_headPiece_facial_geo", "SILO_cow004_grazeCorrective_geo", "SILO_cow004_body_geo", topologyCheck=False, frontOfChain=True, weight=[(0, 1), (1, 1)], name="SILO_cow004_correctives_BS")[0]
graze_bs_node = api.Node(graze_bs, create=False)
user_code_nodes.append(graze_bs_node)
cmds.connectAttr(str(graze_attr), f"{graze_bs}.SILO_cow004_grazeCorrective_geo")


# LEG CORRECTIVES ---------------------------------------------------------
source = api.DagNode("SILO_cow004_body_geo", create=False)
target = api.DagNode("SILO_cow004_frontLeg_L_corrective_geo", create=False)
...
target = api.DagNode("SILO_cow004_frontLeg_R_corrective_geo", create=False)
...
cmds.container("SILO_cow004_RIG", edit=True, addNode=[i.name for i in user_code_nodes])
